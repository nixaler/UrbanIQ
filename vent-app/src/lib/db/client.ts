...
//
// Lazy on purpose: several layouts/pages transitively import this module. If
// DATABASE_URL validation ran at import time, Next's build-time page-data
// collection would crash on routes that never actually touch the database.
