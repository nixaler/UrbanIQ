...
import { narrationPipeline } from '@/lib/inngest/functions/narrationPipeline';

export const { GET, POST, PUT } = serve({
  client: inngest,
  functions: [contentPipeline, streakReset, notificationDispatch, dailyDigest, narrationPipeline],
});
