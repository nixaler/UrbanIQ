...
const NYC_RAW:any[]=[
  ...
  ["Eastern Pkwy-Brooklyn Museum",["2","3"],"Brooklyn",3,1920,"Crown Heights cultural anchor — Brooklyn Museum and Botanic Garden","The Brooklyn Museum is the second-largest art museum in the United States by building size."],
  ...
  ["Forest Hills-71 Av",["E","F","M","R"],"Queens",3,1936,"Forest Hills landmark — near the famous West Side Tennis Club","Forest Hills Gardens was built in 1908 as a model residential community — Tudor-style homes are preserved today."],
];
